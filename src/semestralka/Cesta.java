...
public class Cesta implements Comparable<Cesta> {
	 ...
	 * 
	 * @param idFrom
	 *            - Identifikaèní èíslo hospody/pøekladištì, ze kterého cesta
	 *            vede.
	 * @param idTo
	 *            - Identifikaèní èíslo hospody/pøekladištì, do kterého cesta
	 *            vede.
	 * @param vzdalenost
	 *            - Vzdálenost v kilometrech mezi dvìma místy.
	 */
